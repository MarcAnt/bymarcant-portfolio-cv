...
closeModal.addEventListener("mouseleave", function () {
  closeModal.style.transform = "rotate(0)";
});
...
const mediaQueryModal = window.matchMedia(
...
const mqPortfolioModalMid = window.matchMedia(
...
closeContactModal.addEventListener("mouseover", function () {
  closeContactModal.style.transform = "rotate(90deg)";
});
closeContactModal.addEventListener("mouseleave", function () {
  closeContactModal.style.transform = "rotate(0)";
});
...
const mediaQueryModalContact = window.matchMedia(
  "(min-width: 1025px) and (max-width: 2560px)"
);
...
const mqContactModalMid = window.matchMedia(
  "(min-width: 769px) and (max-width: 1024px)"
);
...
closeSkillsModal.addEventListener("mouseover", function () {
  closeSkillsModal.style.transform = "rotate(90deg)";
});
closeSkillsModal.addEventListener("mouseleave", function () {
  closeSkillsModal.style.transform = "rotate(0)";
});
...
const mediaQueryModalSkills = window.matchMedia(
  "(min-width: 1025px) and (max-width: 2560px)"
);
...
const mqSkillsModalMid = window.matchMedia(
  "(min-width: 769px) and (max-width: 1024px)"
);
...
closeGoalsModal.addEventListener("mouseover", function () {
  closeGoalsModal.style.transform = "rotate(90deg)";
});
closeGoalsModal.addEventListener("mouseleave", function () {
  closeGoalsModal.style.transform = "rotate(0)";
});
...
const mediaQueryModalGoals = window.matchMedia(
  "(min-width: 1025px) and (max-width: 2560px)"
);
...
const mqGoalsModalMid = window.matchMedia(
  "(min-width: 769px) and (max-width: 1024px)"
);
...
const anchor = document.getElementById("download-cv");
const getResumeFile = async () => {
  const fileBlob = await fetch("../public/resume/English_CV.pdf");
  const getFileBlob = await fileBlob.blob();
  const dataURI = URL.createObjectURL(getFileBlob);
  return dataURI;
};

const setResume = async () => {
  const getResume = await getResumeFile();
  anchor.href = getResume;
};

setResume().then(() => {
  anchor.addEventListener("click", async (e) => {
    anchor.download = "Marcos_Esqueda_resume.pdf";
  });
});
